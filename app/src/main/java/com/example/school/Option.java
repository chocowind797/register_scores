            ...
            try {
                ...
                new AlertDialog.Builder(ToTableGrades.this)
                        ...
                        .setPositiveButton("開啟檔案位置", (dialog, which) -> {
                            ...
                            intent.setDataAndType(FileProvider.getUriForFile(ToTableGrades.this, BuildConfig.APPLICATION_ID + ".fileProvider", Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS)), "*/*");
